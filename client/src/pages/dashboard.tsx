  ...
  return (
    <div className="min-h-screen bg-white relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 py-8 mt-20">
        ...
        {/* Footer */}
        <footer className="relative bg-gradient-to-br from-purple-700 via-purple-600 to-purple-800 py-16 mt-20">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
              ...
              <div className="space-y-4">
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-2xl font-bold text-white">SkyHit</span>
                </div>
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  <a href="#" className="block text-purple-200 hover:text-white transition-colors text-sm">Features</a>
                  <a href="#" className="block text-purple-200 hover:text-white transition-colors text-sm">Pricing</a>
                  <a href="#" className="block text-purple-200 hover:text-white transition-colors text-sm">Security</a>
                  <a href="#" className="block text-purple-200 hover:text-white transition-colors text-sm">Integrations</a>
                </div>
              </div>
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  <a href="#" className="block text-purple-200 hover:text-white transition-colors text-sm">About Us</a>
                  <a href="#" className="block text-purple-200 hover:text-white transition-colors text-sm">Careers</a>
                  <a href="#" className="block text-purple-200 hover:text-white transition-colors text-sm">Blog</a>
                  <a href="#" className="block text-purple-200 hover:text-white transition-colors text-sm">Press</a>
                </div>
              </div>
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  <a href="#" className="block text-purple-200 hover:text-white transition-colors text-sm">Help Center</a>
                  <a href="#" className="block text-purple-200 hover:text-white transition-colors text-sm">Documentation</a>
                  <a href="#" className="block text-purple-200 hover:text-white transition-colors text-sm">Contact</a>
                  <a href="#" className="block text-purple-200 hover:text-white transition-colors text-sm">Status</a>
                </div>
              </div>
            </div>
