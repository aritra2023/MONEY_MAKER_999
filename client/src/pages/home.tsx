...
export default function Home() {
  ...
  return (
    <div className="bg-gradient-to-br from-purple-800 via-purple-900 to-indigo-900 text-white min-h-screen font-poppins">
      {/* Navigation */}
      <nav 
      ...
      <section className="text-center pt-32 md:pt-40 pb-20 md:pb-32 px-6 relative overflow-hidden">
        ...
        <div className="mt-16 md:mt-20 flex justify-center animate-slide-up" style={{animationDelay: '0.8s'}}>
          <div className="relative">
            {/* Rocket glow effect */}
            <div className="absolute inset-0 bg-white opacity-20 blur-xl rounded-full transform scale-110 animate-pulse"></div>
            
            {/* Main rocket */}
            <svg className="w-20 md:w-28 lg:w-32 animate-bounce-slow relative z-10" viewBox="0 0 512 512" fill="white">
              <path d="M462.3 62.7C407 7.4 299.2 0 240.2 0 122.6 0 39.2 55.2 0 136.8c24 2 59.2 12 87.2 40s38 63.2 40 87.2C152.8 472.8 209.6 512 240.2 512c59 0 106.8-23.2 154.4-70.8 47.6-47.6 70.8-95.4 70.8-154.4 0-30.6-39.2-87.4-119.2-112.8 0-1.6 6.4-6.4 8-8 24.8-24.8 83.2-40 108-40 13.6 0 25.6 1.6 34.4 3.2z"/>
            </svg>
            
            {/* Rocket trail */}
            <div className="absolute -bottom-6 left-1/2 transform -translate-x-1/2">
              <div className="w-1 h-8 bg-gradient-to-b from-orange-400 to-red-500 opacity-70 animate-pulse"></div>
            </div>
          </div>
        </div>
